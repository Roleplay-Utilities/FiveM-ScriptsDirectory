...
function checkVersion(err,responseText, headers)
	curVersion = LoadResourceFile(GetCurrentResourceName(), "version-stable") -- make sure the "version" file actually exists in your resource root!
...
PerformHttpRequest("https://raw.githubusercontent.com"..updatePath.."version-stable", checkVersion, "GET")
end)
